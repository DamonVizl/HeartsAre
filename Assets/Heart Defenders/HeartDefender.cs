...
public class HeartDefender : MonoBehaviour, IPointerClickHandler
{
    ...
    public void ChangeToSuperDefender(Card card)
    {
        ...
        // nstantiate a new GameObject for the SuperDefender
        ...
        // Initialize the new SuperDefender component
        ...
        // Check for win state after adding the SuperDefender
